...
const AllCompletedFuelRequests: React.FC = () => {
  ...
  return (
    <div className="main-container0001">
      <div className="pd-ltr-20">
        <div className="rowCheck pb-4 pt-4 height-100-p">{/* <h4 className="cardHearder">All Deals</h4> */}</div>
...
export default AllCompletedFuelRequests;
